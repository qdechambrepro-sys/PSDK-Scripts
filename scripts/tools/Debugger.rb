...
#
# To use load it, write `ScriptLoader.load_tool('Debugger')`
module Debugger
  # Warp Error message
...
ScriptLoader.load_tool('Debugger/Debug')
ScriptLoader.load_tool('Debugger/Debug MainUI')
ScriptLoader.load_tool('Debugger/Groups')
ScriptLoader.load_tool('Debugger/SystemTags')
ScriptLoader.load_tool('Debugger/Terminal')
ScriptLoader.load_tool('Debugger/WorldMapEditor') if PARGV[:worldmap]
ScriptLoader.load_tool('Editors/SystemTags') if PARGV[:tags]